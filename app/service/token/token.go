...
func (u *userToken) GenerateToken(userid int64, username string, phone string, role string, extent int64, expireAt int64) (tokens string, err error) {
...
func (u *userToken) TokenIsMeetRefreshCondition(token string) bool {
	...
	_, code := u.isNotExpired(token, variable.ConfigYml.GetInt64("Token.JwtTokenRefreshAllowSec"))
	switch code {
