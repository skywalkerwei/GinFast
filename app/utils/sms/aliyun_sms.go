...
func (s *AliSms) SendCode(template string, phone string, code string) error {
	...
	regionId := variable.ConfigYml.GetString("AliYun.Sms.Endpoint")
	accessKeyId := variable.ConfigYml.GetString("AliYun.Sms.AccessKeyID")
	accessSecret := variable.ConfigYml.GetString("AliYun.Sms.AccessKeySecret")
	signName := variable.ConfigYml.GetString("AliYun.Sms.SignName")
	//调用阿里云短信接口发送短信
