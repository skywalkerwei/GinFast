...
import (
	_ "ginfast/app/core/destroy" // 监听程序退出信号，用于资源的释放
	"ginfast/app/global/my_errors"
	"ginfast/app/global/variable"
	"ginfast/app/http/validator/common/register_validator"
	"ginfast/app/service/sys_log_hook"
	"ginfast/app/utils/casbin_v2"
	"ginfast/app/utils/gorm_v2"
	"ginfast/app/utils/snow_flake"
	"ginfast/app/utils/validator_translation"
	"ginfast/app/utils/websocket/core"
	"ginfast/app/utils/yml_config"
	"ginfast/app/utils/zap_factory"
	"log"
	"os"
)
